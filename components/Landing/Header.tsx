    ...
    <div className="flex-auto">
      <nav className="flex justify-between items-center pt-12 max-w-6xl mx-10 lg:m-auto">
        ...
        <div className="hidden md:flex md:space-x-6 lg:space-x-8 items-center">
          <a
            href="#"
            className="font-sourceSansPro transition-all duration-300 border-b-2 border-transparent hover:border-green-600 py-5 text-lightBlack hover:text-black text-lg font-medium"
          >
            Blog
          </a>
          <a
